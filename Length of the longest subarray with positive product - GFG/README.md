...
{1, -2, -3}.</span><span style="font-size:18px">Therefore, the required length is 3.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
length is 2.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
