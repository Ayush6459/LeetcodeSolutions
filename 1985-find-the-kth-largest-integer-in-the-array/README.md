...
<pre style="position: relative;"><strong>Input:</strong> nums = ["3","6","7","10"], k = 4
...
<pre style="position: relative;"><strong>Input:</strong> nums = ["2","21","12","1"], k = 3
...
<pre style="position: relative;"><strong>Input:</strong> nums = ["0","0"], k = 2
