...
findElements.find(2); // return True <div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
findElements.find(5); // return False<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
